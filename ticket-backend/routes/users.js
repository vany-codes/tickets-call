...
router.put("/:id", validateId, updateUser); // ruta para actualizar un usuario existente, el ID del usuario se pasa como parámetro en la URL
...
router.delete("/:id", validateId, deleteUser); // ruta para eliminar un usuario, el ID del usuario se pasa como parámetro en la URL
